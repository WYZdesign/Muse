...
export const MUSE_KNOWLEDGE_BASE: MuseDoc[] = [
  ...
  { section: "subscription", title: "Subscription and billing", content: "Muses Pro is the paid tier. Billing is handled through Stripe Checkout. Subscription upgrades happen through the checkout flow; cancellation and billing management are available in account settings." },
  ...
  { section: "ai", title: "AI features", content: "Muse uses AI for matching and recommendations (semantic profile similarity) and for an in-app support assistant. The support assistant answers questions about how Muses by WYZ works, safety, and account help using this knowledge base." },
];
