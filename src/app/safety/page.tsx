...
export const metadata: Metadata = {
  ...
  description: "Muses by WYZ community standards for creative professional networking.",
};
    ...
    <main style={{ minHeight: "100vh", background: "#0a0612", color: "#f5f0ff", padding: "60px 20px 100px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", fontFamily: "system-ui, sans-serif" }}>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.85)" }}>Muses by WYZ exists to connect creatives for professional work. Treat every interaction as a potential collaboration. Introduce yourself properly, discuss rates upfront, and follow through on commitments.</p>
        </section>
