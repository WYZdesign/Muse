...
function MusePage() {
  ...
  const getReferralTier = (c:number) => c>=50?{tier:"Platinum",discount:20,perks:"20% off all services"}:c>=20?{tier:"Gold",discount:20,perks:"20% off all services"}:c>=5?{tier:"Silver",discount:10,perks:"10% off all services"}:c>=1?{tier:"Bronze",discount:0,perks:"Exclusive badge"}:{tier:"None",discount:0,perks:"Invite friends to earn"};
