              ...
              <div className="onboard" style={{paddingTop:30}}>
                ...
                <div style={{width:"100%",maxWidth:320}}>
                  ...
                  <div style={{display:"flex",gap:10}}>
                    <button className="auth-social-btn" style={{flex:1,width:"auto",minWidth:0,padding:"14px 6px",gap:6,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}} onClick={()=>handleOAuth("google")}><svg width="16" height="16" viewBox="0 0 48 48" style={{flexShrink:0}}><path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.4 29.3 35 24 35c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5c10 0 19.5-7.3 19.5-19.5 0-1.3-.1-2.3-.4-3.5z"/><path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16 19 12.5 24 12.5c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5 16.3 4.5 9.7 8.8 6.3 14.7z"/><path fill="#4CAF50" d="M24 43.5c5.4 0 10.3-2.1 14-5.4l-6.5-5.5C29.6 34 26.9 35 24 35c-5.3 0-9.7-2.6-11.3-7.5l-6.5 5C9.6 40.2 16.2 43.5 24 43.5z"/><path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.3 5.6l6.5 5.5C41.4 35.7 43.5 30.3 43.5 24c0-1.3-.1-2.3-.4-3.5z"/></svg><span style={{overflow:"hidden",textOverflow:"ellipsis"}}>Google</span></button>
                    <button className="auth-social-btn" style={{flex:1,width:"auto",minWidth:0,padding:"14px 6px",gap:6,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}} onClick={()=>handleOAuth("facebook")}><svg width="16" height="16" viewBox="0 0 48 48" style={{flexShrink:0}}><path fill="#1877F2" d="M48 24C48 10.7 37.3 0 24 0S0 10.7 0 24c0 11.9 8.7 21.8 20 23.6V31h-6v-7h6v-5.3c0-5.9 3.5-9.2 8.9-9.2 2.6 0 5.3.5 5.3.5v5.8h-3c-2.9 0-3.8 1.8-3.8 3.7V24h6.5l-1 7h-5.5v16.6C39.3 45.8 48 35.9 48 24z"/></svg><span style={{overflow:"hidden",textOverflow:"ellipsis"}}>Facebook</span></button>
                    <button className="auth-social-btn" style={{flex:1,width:"auto",minWidth:0,padding:"14px 6px",gap:6,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}} onClick={()=>handleOAuth("x")} aria-label="Continue with X"><svg width="16" height="16" viewBox="0 0 24 24" style={{flexShrink:0}}><path fill="#fff" d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg><span style={{overflow:"hidden",textOverflow:"ellipsis"}}>X</span></button>
                  </div>
