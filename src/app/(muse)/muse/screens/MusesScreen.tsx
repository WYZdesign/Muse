  ...
  return (
    <div className={"screen-el" + (screen === "matches" ? " active" : "")}>
      ...
      {showLikesYou ? (
        ...
        <div className="match-list" style={matchesView === "grid" ? { flex: 1, minHeight: 0, display: "grid", gridTemplateColumns: "repeat(2,1fr)", gridAutoFlow: "row", gridAutoRows: "auto", columnGap: 16, rowGap: 16, alignContent: "flex-start", overflowY: "auto", padding: "16px 16px 112px", boxSizing: "border-box" } : { flex: 1, display: "flex", flexDirection: "column", alignItems: "stretch", justifyContent: "flex-start", overflowY: "auto", padding: "0 16px 80px", gap: 10 }}>
          {matches.length === 0 && (
