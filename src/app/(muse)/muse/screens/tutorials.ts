...
export const TUTORIALS: Record<string, TutorialDef> = {
  ...
  connections: {
    ...
    title: "Feed",
    steps: [
      { id: "post", title: "Your Feed", anchor: "card", body: "This is where creatives share work, updates, and behind-the-scenes moments. Scroll to see what your community is up to." },
      ...
      { id: "nav", title: "Move Around", anchor: "nav", body: "The bottom bar takes you between Discover, Feed, Collab, Muses, and BTS at any time." },
    ],
  },
  briefs: {
    key: "briefs",
    ...
    steps: [
      ...
      { id: "nav", title: "Navigate", anchor: "nav", body: "Switch between screens anytime using the bottom bar." },
    ],
  },
  matches: {
    key: "matches",
    title: "Muses",
    steps: [
      { id: "matches", title: "Your Muses", anchor: "card", body: "People you've matched with appear here. Tap one to open a chat, view their profile, or manage the connection." },
      ...
      { id: "nav", title: "Navigate", anchor: "nav", body: "Use the bottom bar to move between screens." },
    ],
  },
  moments: {
    key: "moments",
    title: "BTS",
    steps: [
      { id: "moments", title: "Behind the Scenes", anchor: "card", body: "BTS is a live feed of short moments from creatives — set photos, gear shots, on-location snaps. They disappear after a while, so check back often." },
      ...
      { id: "nav", title: "Navigate", anchor: "nav", body: "The bottom bar moves you between all your screens." },
    ],
  },
  profile: {
    key: "profile",
    title: "Your Profile",
    steps: [
      { id: "profile", title: "Your Profile", anchor: "header", body: "This is how other creatives see you. Your photo, type, bio, stats, and portfolio all live here." },
  ...
  settings: {
    ...
    title: "Settings",
    steps: [
      { id: "settings", title: "Settings", anchor: "header", body: "Everything you can control lives here — discovery preferences, notifications, connected accounts, theme, and more." },
