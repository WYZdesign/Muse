          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flexShrink: 0, width: 52 }}>
            {editingStatus ? (
              ...
              <div
                ...
                style={{ width: 52, height: 18, lineHeight: "18px", textAlign: "center", cursor: "pointer", fontSize: 9, color: "#FFD700", fontWeight: 700, padding: "0 2px", background: "rgba(255,215,0,0.08)", border: "1px solid rgba(255,215,0,0.15)", borderRadius: 99, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
              >
                {userStatus || "+ status"}
              </div>
            )}
