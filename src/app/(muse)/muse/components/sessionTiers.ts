...
export const SESSION_TIERS = [
  { key: "elite", label: "Muses Elite", icon: "✦", minSessions: 25, minRating: 4.8, bg: "rgba(255,215,0,0.16)", border: "rgba(255,215,0,0.4)", color: "var(--gold)" },
  ...
  { key: "rising", label: "Rising Muses", icon: "◆", minSessions: 3, minRating: 4.0, bg: "rgba(212,165,255,0.14)", border: "rgba(212,165,255,0.3)", color: "var(--lavender)" },
] as const;
