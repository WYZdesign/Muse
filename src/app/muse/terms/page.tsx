  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "120px 24px 80px", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.8, fontSize: 15 }}>
        ...
        <p style={{ marginBottom: 16 }}>All paid bookings are processed via Stripe Connect. Muse charges a combined 15% platform fee on each completed booking, split as a 7% host service fee and an 8% buyer service fee (both shown transparently before checkout). Refund disputes are between the provider and the client; Muse will mediate if needed. Tipping is non-refundable.</p>
