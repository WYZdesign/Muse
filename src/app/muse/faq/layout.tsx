...
export const metadata: Metadata = {
  ...
  openGraph: { title: "FAQ — Muses by WYZ", description: "Frequently asked questions about Muse: launch, verification, pricing, safety, and how it differs from other platforms.", url: getFaqUrl(), siteName: "Muse", type: "website" },
