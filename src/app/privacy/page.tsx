    ...
    <main style={{ minHeight: "100vh", background: "#0a0612", color: "#f5f0ff", padding: "60px 20px 100px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", fontFamily: "system-ui, sans-serif" }}>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.85)" }}>Muses by WYZ is strictly for ages 18+. We do not knowingly collect data from children. If you believe a child has used Muse, contact us immediately — we will delete all associated data within24 hours.</p>
        </section>
